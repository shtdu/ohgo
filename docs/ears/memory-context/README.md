...
Persistent cross-session memory, context loading from CLAUDE.md files, and memory search/retrieval.

## Requirements

| ID | Title | Pattern |
|----|-------|---------|
| [REQ-MC-001](#req-mc-001-persistent-cross-session-memory) | Persistent Cross-Session Memory | Optional Feature |
| [REQ-MC-002](#req-mc-002-memory-discovery-on-session-start) | Memory Discovery on Session Start | Event-Driven |
| [REQ-MC-003](#req-mc-003-project-instruction-loading) | Project Instruction Loading | Event-Driven |
| [REQ-MC-004](#req-mc-004-memory-search) | Memory Search | Event-Driven |
| [REQ-MC-005](#req-mc-005-memory-entry-management) | Memory Entry Management | Event-Driven |
| [REQ-MC-006](#req-mc-006-memory-size-limits) | Memory Size Limits | Event-Driven |
